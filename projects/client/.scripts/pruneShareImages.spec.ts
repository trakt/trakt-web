      ...
      const bucket = makeBucket([
        {
          key: 'images/share/og/movie/the-dark-knight/image.png',
          customMetadata: {
            cachedAt: cachedAt(12 * 60 * 60 * 1000), // exactly 12h ago
            releasedAt: releasedAt(7),
          },
        },
      ]);
      ...
      const bucket = makeBucket([
        {
          ...
          customMetadata: {
            cachedAt: cachedAt(13 * 60 * 60 * 1000), // 13h ago
            releasedAt: releasedAt(14), // exactly at the tier 1 edge
          },
        },
      ]);
      ...
      const bucket = makeBucket([
        {
          ...
          customMetadata: {
            cachedAt: cachedAt(13 * 60 * 60 * 1000), // 13h ago
            releasedAt: releasedAt(14 + 1 / 24), // 14d + 1h
          },
        },
      ]);
      ...
      const bucket = makeBucket([
        {
          ...
          customMetadata: {
            cachedAt: cachedAt(60 * 60 * 1000), // 1h ago, would be skipped if it had releasedAt
          },
        },
      ]);
      ...
      const bucket = makeBucket([
        {
          ...
          customMetadata: {
            cachedAt: String(NOW - 11 * 60 * 60 * 1000),
            releasedAt: String(NOW - 7 * 24 * 60 * 60 * 1000),
          },
        },
      ]);
