<script lang="ts">
  ...
  import type { SearchFieldProps } from "./models/SearchFieldProps";
  ...
  onMount(() => {
    ...
    requestAnimationFrame(() => {
      // preventScroll so autofocus never scrolls the field into view, which
      // would shift content under the fixed navbar.
...
<div
  class="trakt-search"
  class:search-is-loading={isLoading}
  ...
  .trakt-search {
    ...
    .trakt-search-input {
      ...
      &::-webkit-search-cancel-button {
        ...
        width: var(--ni-16);
        height: var(--ni-16);
        background-image: url("$lib/components/form/SearchClearIcon.svg");
