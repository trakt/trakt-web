import type {
  MessageBannerConfig,
  PromotionConfig,
} from '../models/PromotionConfig.ts';

// Promotion times are in UTC
// FIXME: extract logic from buildLocalDate and start months at 1
export const PROMOTIONS: Record<string, PromotionConfig | MessageBannerConfig> =
  {
    blackFriday: {
      id: 'black-friday',
      type: 'promotion',
    ...
    collection2026: {
      ...
      audience: 'all',
      start: { year: 2025, month: 11, day: 22, hour: 12, minute: 1, second: 0 },
      end: { year: 2027, month: 0, day: 31, hour: 23, minute: 59, second: 59 },
      message: 'You gotta export your collection.',
    },
  };
