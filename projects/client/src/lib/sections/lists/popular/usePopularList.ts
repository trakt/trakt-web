...
function typeToQuery(
  ...
  switch (type) {
    case 'movie':
      return moviePopularQuery(params) as PaginatableInfiniteQuery<
        PopularEntry
      >;
    case 'show':
      return showPopularQuery(params) as PaginatableInfiniteQuery<PopularEntry>;
    case 'media':
      return mediaPopularQuery(params) as PaginatableInfiniteQuery<
        PopularEntry
      >;
  }
}
