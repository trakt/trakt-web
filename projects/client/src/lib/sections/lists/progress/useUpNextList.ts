...
function typeToQuery(props: UpNextStoreProps) {
  switch (props.type) {
    case 'movie':
      return movieProgressQuery(props) as PaginatableInfiniteQuery<
        ProgressEntry
      >;
    case 'show':
      return upNextNitroQuery(props) as PaginatableInfiniteQuery<ProgressEntry>;
    default:
      return mediaProgressQuery(props) as PaginatableInfiniteQuery<
        ProgressEntry
      >;
  }
}
