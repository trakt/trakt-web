...
function typeToQuery(
  ...
  switch (type) {
    case 'movie':
      return movieActivityHistoryQuery(params) as PaginatableInfiniteQuery<
        HistoryEntry
      >;
    case 'episode':
      return episodeActivityHistoryQuery(params) as PaginatableInfiniteQuery<
        HistoryEntry
      >;
    case 'show':
      return showActivityHistoryQuery(params) as PaginatableInfiniteQuery<
        HistoryEntry
      >;
    case 'all':
      return activityHistoryQuery(params) as PaginatableInfiniteQuery<
        HistoryEntry
      >;
  }
}
