...
describe('util: toCoverMediaRef', () => {
  ...
  it('should recover an episode reference from a screenshot url', () => {
    expect(
      toCoverMediaRef(
        'https://media.trakt.tv/images/episodes/000/298/461/screenshots/medium/abc123.jpg.webp',
      ),
  ...
  it('should ignore image size and extension differences', () => {
    const original = toCoverMediaRef(
      'https://media.trakt.tv/images/movies/000/916/302/fanarts/original/626327d7b4.jpg',
    );
