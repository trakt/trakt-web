...
import { isTvAgent } from './isTvAgent.ts';

describe('isTvAgent', () => {
  it('should return false when userAgent is null', () => {
    expect(isTvAgent(null)).toBe(false);
  });

  it('should return false when userAgent is undefined', () => {
    expect(isTvAgent(undefined)).toBe(false);
  });
  ...
  it('should return true for Android TV user agents', () => {
    ...
    expect(isTvAgent(androidTvUserAgent)).toBe(true);
  });
  ...
  it('should return false for regular Android user agents without TV', () => {
    ...
    expect(isTvAgent(androidUserAgent)).toBe(false);
  });
  ...
  it('should return false for non-Android user agents', () => {
    ...
    expect(isTvAgent(iosUserAgent)).toBe(false);
    expect(isTvAgent(desktopUserAgent)).toBe(false);
  });
});
