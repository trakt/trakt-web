...
export const MovieHereticLanguageResponseMock: TranslationResponse = [
  ...
  },
  {
    ...
    'tagline': 'Budete se modlit, aby vás nechal odejít',
    'language': 'cs',
    'country': 'cz',
  },
  {
  ...
  },
  {
    'title': null,
    'overview':
      'Zwei junge Missionare müssen ihren Glauben unter Beweis stellen, als sie an die falsche Tür klopfen und dort vom teuflischen Mr. Reed begrüßt werden. Sie geraten in dessen tödliches Katz-und-Maus-Spiel.',
    'tagline': null,
    'language': 'de',
    'country': 'de',
  },
  ...
  },
  {
    'title': 'مرتد',
    'overview':
      'دو مبلغ مذهبی جوان مجبور می‌شوند ایمان خود را ثابت کنند وقتی درب اشتباهی را زده و توسط آقی رید شیطانی مورد استقبال قرار می‌گیرند و در بازی مرگبار موش و گربه او گرفتار می‌شوند.',
    'tagline': 'به همه چیز شک کن.',
    'language': 'fa',
    'country': 'ir',
  },
  {
    'title': 'Heretic - Epäuskoinen',
    'overview':
  ...
  },
  {
    'title': null,
    'overview':
      "eux jeunes missionnaires mormones se rendent chez M. Reed, un homme excentrique, pour prêcher et tenter de le convertir. Ce dernier va cependant s'avérer bien plus dangereux qu'elles n'auraient pu l'imaginer.",
    'tagline': null,
    'language': 'fr',
    'country': 'fr',
  },
  ...
  },
  {
    ...
    'tagline': 'Kérdőjelezz meg mindent',
    'language': 'hu',
    'country': 'hu',
  },
  {
  ...
  },
  {
    ...
    'tagline': 'Klausk, ir bus atsakyta',
    'language': 'lt',
    'country': 'lt',
  },
  {
  ...
  },
  {
    ...
    'tagline': 'Budete sa modliť, aby vás nechal odísť.',
    'language': 'sk',
    'country': 'sk',
  },
  {
