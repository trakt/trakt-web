...
export const LibraryMappedMock: LibraryItem[] = [
  {
    'addedAt': new Date('2025-09-04T18:06:29.000Z'),
    'availableOn': [],
    'episode': {
      ...
      'rating': 0.7463,
      'votes': 797,
      'updatedAt': new Date('2025-11-05T07:42:59.000Z'),
      'runtime': 22,
      'season': 27,
      'title': 'Wok Is Dead',
      'type': 'standard',
    ...
    'media': {
      ...
      'trailer': undefined,
      'type': 'show',
      'updatedAt': new Date('2025-11-05T07:43:05.000Z'),
      'votes': 21868,
      'year': 1997,
    },
    'type': 'episode',
  ...
  {
    'addedAt': new Date('2025-07-17T12:56:38.000Z'),
    'availableOn': [],
    'key': 'movie-1153578',
    'media': {
      ...
      'originalTitle': 'The Death of Snow White',
      'overview':
      ...
      'type': 'movie',
      'updatedAt': new Date('2025-11-02T17:06:07.000Z'),
      'votes': 23,
      'year': 2025,
    },
    'type': 'movie',
  ...
  {
    'addedAt': new Date('2025-05-16T11:33:30.000Z'),
    'availableOn': [
      'plex',
    ],
    'key': 'movie-7',
    'media': {
      ...
      'updatedAt': new Date('2025-11-04T08:13:15.000Z'),
      'type': 'movie',
      'votes': 46279,
      'year': 1977,
    },
  ...
  {
    'addedAt': new Date('2021-12-29T13:41:41.000Z'),
    'availableOn': [
      'plex',
    ],
    'episode': {
      ...
      'rating': 0.7738,
      'votes': 897,
      'updatedAt': new Date('2025-11-04T15:51:58.000Z'),
      'runtime': 22,
      'season': 1,
      'title': 'Pilot',
    ...
    'media': {
      ...
      'trailer': undefined,
      'type': 'show',
      'updatedAt': new Date('2025-11-05T07:47:12.000Z'),
      'votes': 3835,
      'year': 1987,
    },
    'type': 'episode',
